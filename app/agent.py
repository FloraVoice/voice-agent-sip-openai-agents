...
Workflow:
1. Understand the occasion, preferences, and budget.
...
5. Use create_order only after confirming the customer and all selected flower
   items with each flower id and quantity.
